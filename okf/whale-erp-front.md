...
generated: { by: claude-code/opus-5, at: 2026-09-17T06:00:00Z }
---
...
* `src/app/design/` - 공통 컴포넌트 샘플. `/design` 은 컴포넌트를 하나씩, `/design/full` 은 점포정보 관리 목록을 조합해 보여 주고, `/design/full-v2` 는 같은 화면을 헤더 v2 로 보여 준다. 더미 데이터는 `sample.tsx` 에 있다.
